...
export const HOST_EVENTS: HostEvent[] = [
  {
    ...
    participants: [
      { name: 'Nguyen Tran', level: '4.0', status: 'confirmed' },
      { name: 'Le Minh', level: '4.5', status: 'confirmed' },
      { name: 'Tran Duy', level: '3.5', status: 'pending' },
    ],
  },
  {
    ...
    participants: [
      { name: 'Alex Chen', level: '4.0', status: 'pending' },
      { name: 'Sarah Jenkins', level: '3.5', status: 'confirmed' },
      { name: 'Minh Khoa', level: '4.0', status: 'confirmed' },
    ],
  },
  {
    ...
    participants: [
      { name: 'Ngoc Anh', level: 'TB', status: 'pending' },
      { name: 'Hoang Nam', level: 'TB Khá', status: 'confirmed' },
